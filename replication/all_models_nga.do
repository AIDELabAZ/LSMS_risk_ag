...
* create variable to record the name of the shock variable
	sort		shock
	gen 		aux_var = 1 if shock == "v07"
	replace 	aux_var = 2 if shock == "v09"
	replace 	aux_var = 3 if shock == "v11"
	replace 	aux_var = 4 if shock == "v13"
	replace 	aux_var = 5 if shock == "v14"

* order and label the varaiable
	order 		aux_var, after(shock)
	lab def		shock 	1 "Z-Score of Total Rainfall" ///
						2 "Deviation in Rainy Days" ///
						3 "Deviation in No Rain Days" ///
						4 "Deviation in % Rainy Days" ///
						5 "Longest Dry Spell"
...
* label new variables	
	...
	lab 			var k1 "Rainfall (Production)"
	lab 			var k2 "Rainfall (Shock)"
	...
	twoway 			scatter k1 k2 k3 k4 obs, xlab(0(2)18) xsize(10) ysize(6) ///
						...
						10 "Z-Score of Total Seasonal" 11 "Deviation in Rainy Days" ///
						12 "*{bf:Rainfall (Shock)}*" 14 "CHIRPS" 15 "CPC" 16 "ERA5" /// 
						17 "*{bf:Weather Product}*" 30 " ", ///
