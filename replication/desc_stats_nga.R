...
# Step 1: Load the dataset (fixed)
data <- read_dta("C:/Users/rbrnhm/OneDrive - University of Arizona/weather_and_agriculture/lsms_risk_ag_data/regression_data/nigeria/nga_complete.dta")
