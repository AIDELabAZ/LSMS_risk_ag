...
* define paths
	global export 	"$data/lsms_risk_ag_data/merged_data/uganda/wave_4"
	global root 	"$data/lsms_risk_ag_data/refined_data/uganda/wave_4"
	global logout 	"$data/lsms_risk_ag_data/merged_data/uganda/logs"
